...
def setup_jax(*, simulation: bool = True) -> None:
    ...
    if simulation:
        ...
        jax.config.update("jax_enable_x64", val=False)  #  MATLAB defaults to double precision
    ...
    if simulation:
        ...
        xla_flags += (
            ...
            "--xla_gpu_autotune_level=1 "  # https://docs.nvidia.com/deeplearning/frameworks/tensorflow-user-guide/index.html#xla-autotune
        )

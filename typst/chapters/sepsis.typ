...
Certain details and specifities are out scope for this project and are not addressed.
...
Any organisms that can cause a disease is called a pathogen, this includes germs, fungi, algae, or parasites.
...
The Sepsis-3 definition has been created by a working group led by the "Society of Critical Care Medicine and the European Society of Intensive Care Medicine" in 2016.
...
While the #acr("qSOFA") has a significantly reduced complexity and is faster to assess it is not as accurate as the #acr("SOFA") score, meaning it has less predictive validity for in-hospital mortality @SOFAscore.

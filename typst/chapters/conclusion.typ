...
Starting point was the #acr("DNM") @Sawicki2022DNM@Berner2022Critical, a functional model of coupled oscillators, representing organ and immune cell populations that can describe both healthy and pathological states related to sepsis.

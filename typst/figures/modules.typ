...
#let sofa_fig = canvas({
    ...
    content("enc.center", [Encoder $g^e_theta$])
    ...
    rect((rel: (0, dh), to: (-2, 0.65)), (rel: (0, dh), to: (-0.25, 1.35)), name: "h0", stroke: 1pt + gray)
    ...
    content("rnn0.center", [RNN $g^r_theta$])
    ...
    bezier((rel: (1, 0), to: "z0.east"), (rel: (0, -dh), to: "rnn0.west"), (-2, 1.1), mark: (end: ">"), stroke: 1.5pt)
    ...
    content("rnn1.center", text(fill: gray.darken(20%))[RNN $g^r_theta$])
    ...
    bezier((rel: (0.5, 0), to: "z1.east"), (rel: (0, -dh), to: "rnn1.west"), (5.3, 1.1), mark: (end: ">"), stroke: (paint: gray.lighten(1%), dash: "dotted"))
